...
},{"./arrayWithoutHoles":"node_modules/@babel/runtime/helpers/arrayWithoutHoles.js","./iterableToArray":"node_modules/@babel/runtime/helpers/iterableToArray.js","./nonIterableSpread":"node_modules/@babel/runtime/helpers/nonIterableSpread.js"}],"node_modules/parcel/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var recordModal = document.querySelector(".record-modal");
var container = document.querySelector(".keys");
recordModal.style.setProperty("--modalYPos", container.getBoundingClientRect().top);
var keys = (0, _toConsumableArray2.default)(document.querySelectorAll(".beat"));
keys.forEach(function (key) {
  key.addEventListener("click", editSound);
});
document.body.addEventListener("click", function (e) {
  if (recording) return;
  var button = e.target.closest(".beat");

  if (!button) {
    document.querySelectorAll(".beat").forEach(function (beat) {
      return beat.dataset.active = "false";
    });
    hideRecordDialog();
  }
});
...
function editSound(e) {
  if (recording) return;
  var state = this.dataset.active;
  (0, _toConsumableArray2.default)(document.querySelectorAll("[data-active]")).forEach(function (key) {
    return key.dataset.active = "false";
  });
...
function showRecordDialog(activeEl) {
  var pos = activeEl.getBoundingClientRect();
  var recordModal = document.querySelector(".record-modal");
...
function _record() {
  _record = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(e) {
    var activeEl, activeKey, recordModal, recorder, stopRecording;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            recording = true;
            activeEl = document.querySelector(".beat[data-active=\"true\"]");
          ...
          case 11:
            ...
            stopRecording = function stopRecording(e) {
              ...
              document.body.removeEventListener("keyup", stopRecording); //document.body.removeEventListener("click", stopRecording);
            };

            document.body.addEventListener("keyup", stopRecording); //document.body.addEventListener("click", stopRecording);
              ...
              stop = function stop() {
                return new Promise(function (resolve) {
                  ...
                  function stop() {
                    ...
                    var audioUrl = URL.createObjectURL(audioBlob); //creating audio el here
...
function addAudio(url, key) {
  ...
  var el = document.querySelector("audio[data-key=\"".concat(key, "\"]"));
  el.playbackRate = 2.0;
  el.src = url;
} //*PLAY THE SOUND--------------------------------------------
...
function playSound(e) {
  if (recording) return;
  var key = e.key;
  var sound = document.querySelector("audio[data-key=\"".concat(key, "\"]"));
  var beat = document.querySelector(".beat[data-key=\"".concat(key, "\"]"));
  if (!sound) return;
  console.log("playing");
...
var beats = (0, _toConsumableArray2.default)(document.querySelectorAll(".beat"));
...
var toggleModalBtn = document.querySelector(".toggle-modal");
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","./style.css":"style.css"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/soundboard.e31bb0bc.js.map